...
Dmitry (https://github.com/reagentoo)
...
Fabian Foerg (https://github.com/faf0)
...
HybridDog - (https://github.com/HybridDog)
...
Jonas Jelten (https://github.com/TheJJ)
...
juan (https://github.com/nyancat18)
	...
	- profile hardening
JustinWayland (https://github.com/JustinWayland)
...
Lucas (https://github.com/lucasmz-dev)
	...
	- profiles: blink-common-hardened: disable noroot to fix saving files
	  (#6920)
...
sofoxe1 (https://github.com/sofoxe1)
...
StellariusOrion592 (https://github.com/StellariusOrion592)
...
tht2005 (https://github.com/tht2005)
	- feature: add arg-max-count / arg-max-len to firejail.config (#6878)
